 ...
 */
static int
cb_adc_table_create(struct dp_ipc_msgbuf *msg_payload)
{
 ...
 */
static int
cb_adc_table_delete(struct dp_ipc_msgbuf *msg_payload)
{
 ...
 */
static int
cb_adc_entry_add(struct dp_ipc_msgbuf *msg_payload)
{
 ...
 */
static int
cb_adc_entry_delete(struct dp_ipc_msgbuf *msg_payload)
{
